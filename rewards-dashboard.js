...
// FTSO Configuration
const FTSO_READER_ADDRESS = '0x78f2D93a84635a0B42756e2bbf7779cf227A0a23';
const FTSO_ABI = [
    {
        "inputs": [],
...
async function getAssetPrices() {
    ...
    try {
        // Use callStatic to perform a read-only call
        const [values, decimals, timestamp] = await ftsoContract.callStatic.getFtsoV2CurrentFeedValues();
