  ...
  app.get('/api/proxy', async (req, res) => {
    try {
      ...
      const allowedDomains = [
        ...
        'songbird-systems-explorer.flare.network',
        'flare-systems-explorer.flare.network',
        'coston-explorer.flare.network',
        'coston2-explorer.flare.network',
        'flare-systems-explorer-backend.aflabs.org',
        'songbird-systems-explorer-backend.aflabs.org'
      ];
...
app.get('/mintNFT', (req, res) => {
 ...
 app.get('/api/env', (req, res) => {
    const env = {
      ...
      SONGBIRD_FACTORY_ADDRESS: process.env.SONGBIRD_FACTORY_ADDRESS,
      FLARE_FACTORY_ADDRESS: process.env.FLARE_FACTORY_ADDRESS,
      SONGBIRD_COLLECTION_REGISTRY_ADDRESS: process.env.SONGBIRD_COLLECTION_REGISTRY_ADDRESS,
      FLARE_COLLECTION_REGISTRY_ADDRESS: process.env.FLARE_COLLECTION_REGISTRY_ADDRESS
    };
